...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD.EMPTY_TITLE_OR_BODY': new InvariantError('tidak dapat membuat thread baru karena title atau body kosong'),
  ...
  'ADD_COMMENT.EMPTY_CONTENT': new InvariantError('tidak dapat membuat comment baru karena content kosong'),
  ...
  'ADD_REPLY.EMPTY_CONTENT': new InvariantError('tidak dapat membuat reply baru karena content kosong'),
};
